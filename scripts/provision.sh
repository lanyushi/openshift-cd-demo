...
function deploy() {
  oc $ARG_OC_OPS new-project dev_$PRJ_SUFFIX   --display-name="Tasks - Dev"
  oc $ARG_OC_OPS new-project stage_$PRJ_SUFFIX --display-name="Tasks - Stage"
  oc $ARG_OC_OPS new-project cicd_$PRJ_SUFFIX  --display-name="CI/CD"
